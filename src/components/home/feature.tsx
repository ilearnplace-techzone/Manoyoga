      ...
      <Container>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={7}>
            ...
            The Manoyoga Counselling Centre provides services like individual counselling, group counselling,
             and organizes various kinds of programmes on mental health online and offline at Jaipur.
            </Typography>
